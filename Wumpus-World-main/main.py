...
background_sound = pygame.mixer.Sound(
    'Wumpus-World-main\\sounds\\bg' + str(random.randint(1, 3)) + '.wav')  # choose a random sound for background
bump_sound, pit_sound = pygame.mixer.Sound('Wumpus-World-main\\sounds\\bump.wav'), pygame.mixer.Sound('Wumpus-World-main\\sounds\\falling.wav')
wumpus_sound, scream_sound = pygame.mixer.Sound('Wumpus-World-main\\sounds\\beast.wav'), pygame.mixer.Sound('Wumpus-World-main\\sounds\\scream.wav')
breeze_sound, stench_sound = pygame.mixer.Sound('Wumpus-World-main\\sounds\\breeze.wav'), pygame.mixer.Sound('Wumpus-World-main\\sounds\\stench.wav')
gold_sound = pygame.mixer.Sound('Wumpus-World-main\\sounds\\victory.wav')
